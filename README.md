...
<li>Exclude posts, pages, custom post types, taxonomy terms (categories, tags, etc.), or user profile pages marked as "No Index".</li>
<li>Enhance the built-in WordPress sitemaps XML with the article modification time.</li>
</ul>

<h1>WPSSO Better WordPress Sitemaps XML</h1>
...
<tr><th align="right" valign="top" nowrap>Tags / Keywords</th><td>xml sitemap, sitemaps, schema, noindex, woocommerce, seo, google</td></tr>
</table>
...
<p>Enhance the WordPress sitemaps XML with article modification times, alternate language URLs, and Schema images for Google rich results.</p>
...
<p>Exclude "No Index" and redirected posts, pages, custom post types, taxonomies (categories, tags, etc.), and user profiles pages.</p>

<!-- /about -->

<h3>WPSSO Core Required</h3>

<p>WPSSO Better WordPress Sitemaps XML (WPSSO WPSM) is an add-on for the <a href="https://wordpress.org/plugins/wpsso/">WPSSO Core plugin</a>.</p>

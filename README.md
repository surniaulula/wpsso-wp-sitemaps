...
<ul>
<li>Manage post and taxonomy types included in the WordPress sitemaps XML.</li>
<li>Exclude posts, pages, custom post types, taxonomy terms (categories, tags, etc.), and user profiles marked as "No Index".</li>
<li>Automatically enhance the built-in WordPress sitemaps XML with the article modification time.</li>
</ul>

...
if ( ! class_exists( 'WpssoWpsmRegister' ) ) {

	class WpssoWpsmRegister {

		public function __construct() {

			register_activation_hook( WPSSOWPSM_FILEPATH, array( $this, 'network_activate' ) );

			register_deactivation_hook( WPSSOWPSM_FILEPATH, array( $this, 'network_deactivate' ) );
		...
		private function activate_plugin() {
			...
			if ( class_exists( 'Wpsso' ) ) {
				...
				if ( class_exists( 'WpssoUtilReg' ) ) {	// Since WPSSO Core v6.13.1.
					...
					$version = WpssoWpsmConfig::get_version();

					WpssoUtilReg::update_ext_version( 'wpssowpsm', $version );
				}
			}
		}

		...
		public function filter_messages_info( $text, $msg_key ) {
			...
			switch ( $msg_key ) {
				...
				case 'info-wpsm-general':
					...
					$text .= sprintf( __( 'To <strong>exclude</strong> individual posts, pages, custom post types, taxonomy terms (categories, tags, etc.), or user profile pages from the WordPress sitemaps XML, enable the <strong>%1$s</strong> option under the %2$s &gt; %3$s metabox tab.', 'wpsso-wp-sitemaps' ), $no_index_label, $sso_mb_title, $robots_tab ) . ' ';

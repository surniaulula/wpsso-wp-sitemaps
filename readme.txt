...
**Version 5.0.0-dev.13 (2022/11/03)**
...
(2022/11/03) Improved performance when creating the sitemaps XML. Added a new "Maximum URLs per Sitemap" option (default is 2000).

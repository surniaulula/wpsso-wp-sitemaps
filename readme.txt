...
**Version 2.1.0-dev.4 (2022/02/17)**
...
(2022/02/17) Removed test for `WpssoUtilRobots->is_enabled()` when checking for noindex, to allow noindex checks even if the robots meta tag is disabled.
